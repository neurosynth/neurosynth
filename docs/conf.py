# -*- coding: utf-8 -*-
#
# neurosynth documentation build configuration file, created by
...
import sys
import os
sys.path.insert(0, os.path.abspath("../neurosynth/analysis"))
sys.path.insert(0, os.path.abspath("../neurosynth/base"))
...
project = u'neurosynth'
copyright = u'2014, Tal Yarkoni'
...
htmlhelp_basename = 'neurosynthdoc'
...
latex_documents = [
  ('index', 'neurosynth.tex', u'neurosynth Documentation',
   u'Tal Yarkoni', 'manual'),
]
...
man_pages = [
    ('index', 'neurosynth', u'neurosynth Documentation',
     [u'Tal Yarkoni'], 1)
]
...
texinfo_documents = [
  ('index', 'neurosynth', u'neurosynth Documentation',
   u'Tal Yarkoni', 'neurosynth', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'neurosynth'
epub_author = u'Tal Yarkoni'
epub_publisher = u'Tal Yarkoni'
epub_copyright = u'2014, Tal Yarkoni'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'neurosynth'
