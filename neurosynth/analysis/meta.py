...
def analyze_features(dataset, features=None, image_type='pFgA_pF=0.50',
    ...
    Args:
        ...
        image_type: The type of image to return. Specify one of the extensions
            generated by the MetaAnalysis procedure--e.g., pFgA_pF=0.50,
            pFgA_emp_priorpAgF, etc. By default, will use pFgA_pF=0.50 (i.e.,
            the probability that a Mappable has a feature given that activation
            is present using a uniform prior).
